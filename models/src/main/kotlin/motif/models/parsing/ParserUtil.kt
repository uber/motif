...
interface ParserUtil {
    ...
    fun IrParameter.toDependency(): Dependency {
        return Dependency(type, getQualifier())
    }

    fun IrMethod.returnedDependency(): Dependency {
        return Dependency(returnType, getQualifier())
    }
}