...
/**
 * Represents the site of a request for a dependency ( [Sink]) or the site at which a dependency is
 * provided ( [Source]).
 */
sealed class Node {
...
sealed class Source : Node() {
  ...
  // Whether or not this Source can override other sources. For instance, a ChildParameterSource is
  // able to
