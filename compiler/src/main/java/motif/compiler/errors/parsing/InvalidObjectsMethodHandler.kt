...
class InvalidObjectsMethodHandler : ErrorHandler<InvalidObjectsMethod>() {

    override fun message(error: InvalidObjectsMethod): String {
        return "Invalid Motif Objects method."
    }

    override fun element(error: InvalidObjectsMethod): Element? {
