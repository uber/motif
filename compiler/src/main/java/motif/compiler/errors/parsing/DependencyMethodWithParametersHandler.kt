...
class DependencyMethodWithParametersHandler : ErrorHandler<DependencyMethodWithParameters>() {
    ...
    override fun message(error: DependencyMethodWithParameters): String {
        return "Motif @Dependency-annotated interfaces can only declare parameterless methods."
    }

    override fun element(error: DependencyMethodWithParameters): Element? {
