...
class NotAssignableBindsMethodHandler : ErrorHandler<NotAssignableBindsMethod>() {
    ...
    override fun message(error: NotAssignableBindsMethod): String {
        return "Type required by @Binds-annotated method is not assignable to provided type."
    }

    override fun element(error: NotAssignableBindsMethod): Element? {
