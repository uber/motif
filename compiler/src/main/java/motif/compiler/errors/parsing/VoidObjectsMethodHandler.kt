...
class VoidObjectsMethodHandler : ErrorHandler<VoidObjectsMethod>() {

    override fun message(error: VoidObjectsMethod): String {
        return "Invalid Motif Objects method."
    }

    override fun element(error: VoidObjectsMethod): Element? {
