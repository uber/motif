...
public class Test {
     ...
     * can initialize while slowDep() holds a different lock.
     */
    public static void run() throws Exception {
        // given a scope where slowDep signals once it holds its lock, then blocks
        ...
        try {
            // when slowDep runs and is confirmed to hold its lock
