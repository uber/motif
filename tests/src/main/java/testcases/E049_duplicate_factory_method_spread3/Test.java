 ...
 */
package testcases.E049_duplicate_factory_method_spread3;
...
public class Test {
    ...
    public static void run() {
        DuplicateFactoryMethodsSubject.assertThat((DuplicateFactoryMethodsError) error)
            .matches("foo", Scope.class);
    }
}
