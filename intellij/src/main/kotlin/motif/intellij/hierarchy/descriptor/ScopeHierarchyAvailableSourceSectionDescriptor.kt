...
open class ScopeHierarchyAvailableSourceSectionDescriptor(
        project: Project,
        graph: ResolvedGraph,
    ...
    override fun updateText(text: CompositeAppearance) {
        val count: Int = getExposedSources(scope, graph, true).count() + getExposedSources(scope, graph, false).count()
        text.ending.addText("Available")
